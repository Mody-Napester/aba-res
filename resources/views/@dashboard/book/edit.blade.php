            ...
            <div class="card-body">
                <form action="{{ route('book.update', [$resource->uuid]) }}" method="post">
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('speciality_'.$lang) is-invalid @enderror "
                                           ...
                                           placeholder="{{ trans('general.enter') }} {{ trans('book.speciality') }} {{ $lang }} .." value="{{ getTrans($resource->speciality, $lang) }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('phone') is-invalid @enderror "
                                       ...
                                       placeholder="{{ trans('general.enter') }} {{ trans('book.phone') }} .." value="{{ $resource->phone }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('email') is-invalid @enderror "
                                       ...
                                       placeholder="{{ trans('general.enter') }} {{ trans('book.email') }} .." value="{{ $resource->email }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('avatar') is-invalid @enderror "
                                       ...
                                       placeholder="{{ trans('general.enter') }} {{ trans('book.avatar') }} .." value="{{ $resource->avatar }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-1">
                                <label class="" for="">{{ trans('book.is_default') }}</label>
                            </div>
