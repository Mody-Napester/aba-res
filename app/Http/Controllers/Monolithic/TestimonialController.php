...
use App\Http\Controllers\Repositories\TestimonialRepositoryController;
...
class TestimonialController extends Controller {
    ...
    {
        $this->repository = new TestimonialRepositoryController('monolithic');
    }
    ...
    public function create(Request $request)
    {
        ...
        if($return_data['status']['reason'] == 'permission_failed'){
            ...
            return view('@dashboard.testimonial.create', $data);
        }
    }
