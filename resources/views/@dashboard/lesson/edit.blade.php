...
@section('content')
    ...
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2 mt-1">
            <div class="breadcrumbs-top">
                ...
                <h5 class="content-header-title float-left pr-1 mb-0">{{ trans('lesson.lesson') }}</h5>
    ...
    <section>
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('lesson.update', [$resource->uuid]) }}" method="post">
                    @csrf
                    @method('put')
                            ...
                            <div class="form-group">
                                ...
                                <select class="select2 form-control @error('session_uuid') is-invalid @enderror" name="session_uuid" id="session_uuid">
                                    ...
                                    @foreach($sessions as $session)
                                        <option @if($resource->session_id == $session->id) selected @endif value="{{$session->uuid}}">{{ getTrans($session->name, lang()) }}</option>
                                    @endforeach
                                </select>
