    ...
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2 mt-1">
            <div class="breadcrumbs-top">
                ...
                <h5 class="content-header-title float-left pr-1 mb-0">{{ trans('course.create') }}</h5>
                <div class="breadcrumb-wrapper d-none d-sm-block">
                    <ol class="breadcrumb p-0 mb-0 pl-1">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard.index') }}"><i class="bx bx-home-alt"></i></a></li>
                        <li class="breadcrumb-item active">{{ trans('course.create') }}</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="select2 form-control @error('instructor_uuid') is-invalid @enderror" name="instructor_uuid" id="instructor_uuid">
                                    ...
                                    <option value="{{$instructor->uuid}}">{{ getTrans($instructor->name, lang()) }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('price') is-invalid @enderror "
                                       ...
                                       placeholder="{{ trans('general.enter') }} {{ trans('course.price') }} .." value="{{ old('price') }}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('time_frame') is-invalid @enderror "
                                       ...
                                       placeholder="{{ trans('general.enter') }} {{ trans('course.time_frame') }} .." value="{{ old('time_frame') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('name_'.$lang) is-invalid @enderror "
                                           ...
                                           placeholder="{{ trans('general.enter') }} {{ trans('course.name') }} {{ $lang }} .." value="{{ old('name_' . $lang) }}">
                        ...
                        @foreach(langs() as $lang)
                            <div class="col-md-6 mb-2">
                                ...
                                <textarea class="form-control @error('short_details_'.$lang) is-invalid @enderror "
                                          ...
                                          placeholder="{{ trans('general.enter') }} {{ trans('course.short_details') }} {{ $lang }} .."></textarea>
