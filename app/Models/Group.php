...
class Group extends Model
{
    ...
    {
        return $this->belongsToMany(Screen::class, 'group_screen_action', 'group_id', 'screen_id')
            ->withTimestamps()->withPivot(['action_id']);
    }
    ...
    {
        return $this->belongsToMany(Action::class, 'group_screen_action', 'group_id', 'action_id')
            ->withTimestamps()->withPivot(['screen_id']);
    }
