...
@section('content')
    ...
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2 mt-1">
            <div class="breadcrumbs-top">
                ...
                <h5 class="content-header-title float-left pr-1 mb-0">{{ trans('social.social') }}</h5>
    ...
    <section>
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('social.update', [$resource->uuid]) }}" method="post">
                    @csrf
                    @method('put')
                            ...
                            <div class="form-group">
                                ...
                                <select class="select2 form-control @error('provider_uuid') is-invalid @enderror" name="provider_uuid" id="provider_uuid">
                                    ...
                                    @foreach($providers as $provider)
                                        <option @if($resource->provider_id == $provider->id) selected @endif value="{{$provider->uuid}}">{{ getTrans($provider->name, lang()) }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('url') is-invalid @enderror "
                                       id="url"
                                       type="url" name="url"
                                       placeholder="{{ trans('general.enter') }} {{ trans('social.url') }} .." value="{{ $resource->url }}">
