...
use App\Http\Controllers\Repositories\CertificateRepositoryController;
...
class CertificateController extends Controller {
    ...
    {
        $this->repository = new CertificateRepositoryController('monolithic');
    ...
    public function index(Request $request)
    {
        ...
        if($return_data['status']['reason'] == 'permission_failed'){
            ...
            return view('@dashboard.certificate.index', $data);
        }
    }
    ...
    public function create(Request $request)
    {
        ...
        if($return_data['status']['reason'] == 'permission_failed'){
            ...
            return view('@dashboard.certificate.create', $data);
        }
    }
    ...
    public function edit(Request $request, $uuid)
    {
        ...
        if($return_data['status']['reason'] == 'permission_failed'){
            ...
            return view('@dashboard.certificate.edit', $data);
        }
    }
