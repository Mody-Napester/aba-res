    ...
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2 mt-1">
            <div class="breadcrumbs-top">
                ...
                <h5 class="content-header-title float-left pr-1 mb-0">{{ trans('question.create') }}</h5>
                <div class="breadcrumb-wrapper d-none d-sm-block">
                    <ol class="breadcrumb p-0 mb-0 pl-1">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard.index') }}"><i class="bx bx-home-alt"></i></a></li>
                        <li class="breadcrumb-item active">{{ trans('question.create') }}</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="select2 form-control @error('quiz_uuid') is-invalid @enderror" name="quiz_uuid" id="quiz_uuid">
                                    ...
                                    @foreach($quizzes as $quiz)
                                        <option value="{{$quiz->uuid}}">{{ getTrans($quiz->name, lang()) }}</option>
                                    @endforeach
                                </select>
                        ...
                        @foreach(langs() as $lang)
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control @error('details_'.$lang) is-invalid @enderror "
                                          ...
                                          placeholder="{{ trans('general.enter') }} {{ trans('question.details') }} {{ $lang }} .."></textarea>
