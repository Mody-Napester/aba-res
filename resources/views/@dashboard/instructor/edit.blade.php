...
@section('content')
    ...
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2 mt-1">
            <div class="breadcrumbs-top">
                <h5 class="content-header-title float-left pr-1 mb-0">{{ trans('instructor.instructores') }}</h5>
    ...
    <section>
        <div class="card">
            ...
            <div class="card-body">
                <form instructor="{{ route('instructor.update', [$resource->uuid]) }}" method="post">
                    @csrf
                    @method('put')
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="{{ trans('instructor.enter_name') }}" value="{{ $resource->name }}" required/>
                            @error('name')
