...
use App\Http\Controllers\Repositories\QuestionRepositoryController;
...
class QuestionController extends Controller {
    ...
    {
        $this->repository = new QuestionRepositoryController('monolithic');
        $this->quiz = new QuizRepositoryController('monolithic');
    }
    ...
    public function create(Request $request)
    {
        ...
        if($return_data['status']['reason'] == 'permission_failed'){
            ...
            $data['quizzes'] = $this->quiz->index(new Request(['is_active' => '1']))['data']['items'];
