...
@section('content')
        ...
        <div class="content-header-left col-12 mb-2 mt-1">
            <div class="breadcrumbs-top">
                <div class="float-right">
                    ...
                    <a href="{{ route('order.create') }}" class="btn btn-sm btn-success"><i class="bx bxs-book-add"></i> {{ trans('general.create_new') }}</a>
                </div>

                <h5 class="content-header-title float-left pr-1 mb-0">{{ trans('order.order') }}</h5>
    ...
    <section>
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('order.update', [$resource->uuid]) }}" method="post">
                    @csrf
                    @method('put')
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('name_'.$lang) is-invalid @enderror "
                                           ...
                                           placeholder="{{ trans('general.enter') }} {{ trans('order.name') }} {{ $lang }} .." value="{{ getTrans($resource->name, $lang) }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('speciality_'.$lang) is-invalid @enderror "
                                           ...
                                           placeholder="{{ trans('general.enter') }} {{ trans('order.speciality') }} {{ $lang }} .." value="{{ getTrans($resource->speciality, $lang) }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('phone') is-invalid @enderror "
                                       ...
                                       placeholder="{{ trans('general.enter') }} {{ trans('order.phone') }} .." value="{{ $resource->phone }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('email') is-invalid @enderror "
                                       ...
                                       placeholder="{{ trans('general.enter') }} {{ trans('order.email') }} .." value="{{ $resource->email }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('avatar') is-invalid @enderror "
                                       ...
                                       placeholder="{{ trans('general.enter') }} {{ trans('order.avatar') }} .." value="{{ $resource->avatar }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-1">
                                <label class="" for="">{{ trans('order.is_default') }}</label>
                            </div>
